...
trait Alynt_Drime_Backups_Uploader_Admin_Page_Notices {
	...
	private function render_notice( $notice ) {
		$messages = array(
			...
			'dashboard_connection_saved'         => array( 'success', __( 'Dashboard pairing shell state saved. The external status endpoint remains disabled.', 'alynt-drime-backups-uploader' ) ),
