...
class Alynt_Drime_Backups_Uploader_Health_Summary {
	...
	private function schedule_management_capability( array $settings, $remote_actions_enabled ) {
		...
		$schedule                  = $this->alynt_scan_upload_schedule_capability( $settings, (bool) $remote_actions_enabled, (bool) $schedule_mutation_enabled );
	 ...
	 * @return array<string,mixed>
	 */
	private function alynt_scan_upload_schedule_capability( array $settings, $remote_actions_enabled, $schedule_mutation_enabled ) {
