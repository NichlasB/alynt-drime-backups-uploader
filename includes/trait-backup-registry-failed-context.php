...
trait Alynt_Drime_Backups_Uploader_Backup_Registry_Failed_Context {
	...
	private function sanitize_failed_context( array $context ) {
		...
		foreach ( array( 'signature', 'name', 'path', 'producer_key', 'producer_label', 'package_id', 'filename', 'backup_set_id', 'manifest_path', 'checksum_path', 'remote_index_path', 'remote_catalog_path', 'checksum_algorithm', 'checksum_value', 'error_code', 'endpoint', 'sidecar_type', 'sidecar_name' ) as $key ) {
