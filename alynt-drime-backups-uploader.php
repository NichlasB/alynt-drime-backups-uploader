...
define( 'ALYNT_DRIME_BACKUPS_UPLOADER_VERSION', '0.5.22' );
...
$alynt_drime_backups_uploader_includes = array(
	...
	'includes/trait-drime-client-direct-upload-response.php',
	'includes/trait-drime-client-multipart.php',
	'includes/trait-folder-browser-normalization.php',
	'includes/trait-folder-browser-path-helpers.php',
	...
	'includes/trait-admin-page-dashboard-settings.php',
	...
	'includes/trait-plugin-hooks.php',
	'includes/trait-plugin-scan-queue.php',
	'includes/trait-plugin-accessors.php',
	'includes/trait-plugin-admin-actions.php',
	'includes/trait-plugin-notification-actions.php',
	'includes/trait-plugin-dashboard-actions.php',
	'includes/interface-producer.php',
	'includes/trait-settings-section-sanitizers.php',
	'includes/trait-settings-path-sanitizers.php',
	'includes/trait-settings-site-identity.php',
	'includes/trait-settings-notification-sanitizers.php',
	'includes/class-settings.php',
	'includes/trait-dashboard-connection-token-parsing.php',
	'includes/trait-dashboard-connection-sanitizers.php',
	'includes/trait-dashboard-connection-state-transitions.php',
	'includes/trait-dashboard-connection-enrollment.php',
	'includes/class-dashboard-connection.php',
	'includes/trait-remote-action-store-sanitizers.php',
	'includes/trait-remote-action-store-schedule-sanitizers.php',
	'includes/class-remote-action-store.php',
	'includes/trait-remote-action-verifier-body-parsing.php',
	'includes/trait-remote-action-verifier-signing.php',
	'includes/trait-remote-action-verifier-sanitizers.php',
	'includes/class-remote-action-verifier.php',
	'includes/class-logger.php',
	'includes/class-failure-notifier.php',
	'includes/class-wpvivid-detector.php',
	'includes/trait-wpvivid-producer-scan-helpers.php',
	'includes/class-wpvivid-producer.php',
	'includes/trait-generic-outbox-producer-scan.php',
	'includes/trait-generic-outbox-producer-normalization.php',
	'includes/trait-generic-outbox-producer-sidecars.php',
	'includes/trait-generic-outbox-producer-archive-helpers.php',
	'includes/trait-generic-outbox-producer-diagnostics.php',
	'includes/class-generic-outbox-producer.php',
	'includes/class-scanner.php',
	'includes/class-backup-registry.php',
	'includes/trait-queue-duplicate-index.php',
	...
	'includes/trait-uploader-failure-handling.php',
	'includes/trait-uploader-local-cleanup.php',
	'includes/trait-uploader-lock.php',
	'includes/trait-uploader-item-preparation.php',
	'includes/trait-uploader-remote-preflight.php',
	...
	'includes/class-dashboard-status-rest-controller.php',
	'includes/class-dashboard-action-intents-rest-controller.php',
	'includes/class-cron.php',
	'includes/trait-remote-action-worker-schedule-handlers.php',
	'includes/trait-remote-action-worker-schedule-preview.php',
	'includes/trait-remote-action-worker-schedule-apply.php',
	'includes/trait-remote-action-worker-schedule-rollback-preview.php',
	'includes/trait-remote-action-worker-schedule-fingerprints.php',
	'includes/trait-remote-action-worker-schedule-cadence.php',
	'includes/trait-remote-action-worker-scan-upload.php',
	'includes/class-remote-action-worker.php',
